...
namespace WBL
{
    ...
    public class OrdenService : IOrdenService
    {
        ...
        public async Task<IEnumerable<OrdenEntity>> Get()
        {
            try
            {
                var result = sql.QueryAsync<OrdenEntity, ProductoEntity>("ObtenerOrden", "IdOrden,IdProducto");
        ...
        public async Task<OrdenEntity> GetById(OrdenEntity entity)
        {
            try
            {
                var result = sql.QueryFirstAsync<OrdenEntity>("ObtenerOrden", new
                { entity.IdOrden });
        ...
        public async Task<DBEntity> Create(OrdenEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("InsertarOrden", new
                {
                    entity.IdProducto,
        ...
        public async Task<DBEntity> Update(OrdenEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("ActualizarOrden", new
                {
                    entity.IdOrden,
                    entity.IdProducto,
                    entity.CantidadProducto,
        ...
        public async Task<DBEntity> Delete(OrdenEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("EliminarOrden", new
                {
                    entity.IdOrden,
                });
